...
WIN_CHROMEDRIVER = os.path.join(BASE_DIR, "driver", "windows", "chromedriver.exe")  # 谷歌浏览器
WIN_FIREFOXDRIVER = os.path.join(BASE_DIR, "driver", "windows", "geckodriver.exe")  # 火狐浏览器
...
### yaml测试用列数据路径
CASEYMAL_DIR = os.path.join(BASE_DIR, "data", "caseyaml", )  # 测试数据
LOCATORYMAL_DIR = os.path.join(BASE_DIR, "data", "locatorYAML", )  # 定位数据
